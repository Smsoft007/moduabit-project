...
uint256 hashGenesisBlock("0x389d85579f085bc849ae2c535d79cfdae1e9115d4a128bd55ef372fda82092ec");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 10000); // ModuaBit: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // ModuaBit: 3.5 days
static const int64 nTargetSpacing = 5 * 60; // ModuaBit: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x093066dee4afb337173c2c8ca6c801efd3f48784c3c41b7f639045fe4c30146f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0479f485d47344cc500e9f0bd39b3cb5153ab1addab0119a7766e776269677722ce48357e5b7d16f649069d2de87e802eb334d492161e7366d0f3f03c44ece13cb") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1613577829;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2087800768;

        if (fTestNet)
        {
            block.nTime    = 1613577803;
            block.nNonce   = 385339645;
        }
	...
	{ 
        ...
        assert(block.hashMerkleRoot == uint256("0xdc5981175cf51a420092a930a2001f736dbcfecbdd1a2b4e43260ab341f9f649"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc3, 0xba, 0xd3 }; // ModuaBit: increase each by adding 2 to bitcoin's value.
